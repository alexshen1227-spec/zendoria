...
> Zendoria renders entirely with HTML5 Canvas 2D. There are no GPU shaders,
> no WebGL pipeline, and no `assets/shaders/` directory. Visual effects are
> achieved with sprite swaps, alpha blending, `globalCompositeOperation`,
> gradients, and offscreen canvases — handled by `technical-artist`, not a
> shader specialist. Re-enable if the project ever adopts WebGL, WebGPU,
> Pixi.js, or Phaser.
