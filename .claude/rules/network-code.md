...
> Zendoria is a single-player offline browser game. There is no networking
> layer, no server, and no multiplayer surface area. Re-enable if and when
> the game adds online co-op, leaderboards backed by a server, or any
