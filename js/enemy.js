...
export const ENEMY_CONFIGS = {
    ...
    coralCrawler: {
        kind: 'coralCrawler',
        src: 'assets/sprites/enemies/coral_crawler_sheet.png',
        frameW: 32,
        frameH: 28,
        hudLabel: 'CORAL CRAWLER',
        toastLabel: 'CRAWLER',
        maxHealth: 3,
        xpReward: 5,
        wanderSpeed: 12,
        ...
        knockbackDuration: 0.12,
        leashRadius: 70,
        hitbox: { x: 6, y: 14, w: 20, h: 12 },
        shadow: { x: 7, y: 23, w: 18, h: 4 },
        flashJitter: { x: 1.2, y: 0.8 },
        spawnSearch: { maxRadius: 80, step: 6 },
        idleDuration: [0.6, 1.2],
        wanderDuration: [0.6, 1.6],
        walkAnimSpeed: 8,
        chaseAnimSpeed: 12,
        // Sheet rows: 0=walk(2 frames), 1=hurt(2), 2=death(2)
        animations: {
            idle: frame(0, 0),
            walk: [frame(0, 0), frame(1, 0)],
            hurt: [frame(0, 1), frame(1, 1)],
            death: [frame(0, 2), frame(1, 2)],
        },
    },
    deepveilSpecter: {
        kind: 'deepveilSpecter',
        src: 'assets/sprites/enemies/deepveil_specter_sheet.png',
        frameW: 28,
        frameH: 36,
        hudLabel: 'DEEPVEIL SPECTER',
        toastLabel: 'SPECTER',
        maxHealth: 2,
        xpReward: 7,
        wanderSpeed: 16,
        ...
        knockbackDuration: 0.10,
        leashRadius: 90,
        hitbox: { x: 6, y: 14, w: 16, h: 18 },
        shadow: { x: 7, y: 32, w: 14, h: 3 },
        flashJitter: { x: 1.3, y: 0.9 },
        spawnSearch: { maxRadius: 90, step: 6 },
        idleDuration: [0.6, 1.3],
        wanderDuration: [0.7, 1.5],
        walkAnimSpeed: 6,
        chaseAnimSpeed: 9,
        // Sheet rows: 0=drift, 1=hurt, 2=fade-out
        animations: {
            idle: frame(0, 0),
            walk: [frame(0, 0), frame(1, 0)],
            hurt: [frame(0, 1), frame(1, 1)],
